                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                            <div class="banner-img">
                                                <img src="<c:url value="/assets/admin/img/banner/1.png"/>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-statistic-4">
                                <div class="align-items-center justify-content-between">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                            <div class="banner-img">
                                                <img src="<c:url value="/assets/admin/img/banner/2.png"/>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-statistic-4">
                                <div class="align-items-center justify-content-between">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                            <div class="banner-img">
                                                <img src="<c:url value="/assets/admin/img/banner/3.png"/>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-statistic-4">
                                <div class="align-items-center justify-content-between">
                                    <div class="row ">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                            <div class="banner-img">
                                                <img src="<c:url value="/assets/admin/img/banner/4.png"/>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-striped">
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-8.png"/>" alt="user" data-toggle="tooltip" title=""
                                                                                                data-original-title="Wildan Ahdian"></li>
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-9.png"/>" alt="user" data-toggle="tooltip" title=""
                                                                                                data-original-title="John Deo"></li>
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-10.png"/>" alt="user" data-toggle="tooltip" title=""
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-1.png"/>" alt="user" data-toggle="tooltip" title=""
                                                                                                data-original-title="Wildan Ahdian"></li>
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-2.png"/>" alt="user" data-toggle="tooltip" title=""
                                                                                                data-original-title="John Deo"></li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-3.png"/>" alt="user" data-toggle="tooltip" title=""
                                                                                                data-original-title="Wildan Ahdian"></li>
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-4.png"/>" alt="user" data-toggle="tooltip" title=""
                                                                                                data-original-title="John Deo"></li>
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-5.png"/>" alt="user" data-toggle="tooltip" title=""
                                                                                                data-original-title="Sarah Smith"></li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-truncate">
                                                <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-7.png"/>" alt="user" data-toggle="tooltip" title=""
                                                                                                data-original-title="John Deo"></li>
                                                    <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                                src="<c:url value="/assets/admin/img/users/user-8.png"/>" alt="user" data-toggle="tooltip" title=""
                                                                                                data-original-title="Sarah Smith"></li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="support-ticket media pb-1 mb-3">
                                    <img src="<c:url value="/assets/admin/img/users/user-1.png"/>" class="user-img mr-2" alt="">
                          ...
                          Deo</span>
                                ...
                                <div class="support-ticket media pb-1 mb-3">
                                    <img src="<c:url value="/assets/admin/img/users/user-2.png"/>" class="user-img mr-2" alt="">
                                    <div class="media-body ml-3">
                          ...
                          Smith</span>
                                ...
                                <div class="support-ticket media pb-1 mb-3">
                                    <img src="<c:url value="/assets/admin/img/users/user-3.png"/>" class="user-img mr-2" alt="">
                                    <div class="media-body ml-3">
                                ...
                                <div class="support-ticket media pb-1 mb-3">
                                    <img src="<c:url value="/assets/admin/img/users/user-6.png"/>" class="user-img mr-2" alt="">
                                    <div class="media-body ml-3">
...
<!-- JS Libraies -->
<script src="<c:url value="/assets/admin/bundles/apexcharts/apexcharts.min.js"/>"></script>
<!-- Page Specific JS File -->
<script src="<c:url value="/assets/admin/js/page/index.js"/>"></script>
<!-- Template JS File -->
