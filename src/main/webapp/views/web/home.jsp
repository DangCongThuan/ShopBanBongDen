                ...
                <div class="slider-wrapper-area">
                    <div class="hero-slider-active hero__1 slick-dot-style hero-dot">
                        <div
                                class="single-slider"
                                style="
                    background-image: url(<c:url value="/assets/web/img/slider/slider11_bg.jpg"/>);
                  "
                        >
                            ...
                            <div class="container p-0">
                                <div class="slider-main-content">
                                    <div class="slider-content-img">
                                        <img
                                                src="<c:url value="/assets/web/img/slider/slider11_lable1.png"/>"
                                                alt=""
                                        />
                                        <img
                                                src="<c:url value="/assets/web/img/slider/slider11_lable2.png"/>"
                                                alt=""
                                        />
                                        <img
                                                src="<c:url value="/assets/web/img/slider/slider11_lable3.png"/>"
                                                alt=""
                                        />
                                    </div>
                                    <div class="slider-text">
                                        <div class="slider-label">
                                            <img
                                                    src="<c:url value="/assets/web/img/slider/slider11_lable4.png"/>"
                                                    alt=""
                                            />
                                        </div>
                        ...
                        <div
                                class="single-slider"
                                style="
                    background-image: url(<c:url value="/assets/web/img/slider/slider12_bg.jpg"/>);
                  "
                        >
                            <div class="container p-0">
                                <div class="slider-main-content">
